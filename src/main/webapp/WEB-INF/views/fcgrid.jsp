...
<%
	...
	tp = request.getAttribute("pages");
	totalPage = (Integer)tp;
%>
	<header>
...
<p align=center><input type="submit" value="필터적용">&nbsp;&nbsp;&nbsp;
	<input type="button" onclick="location.href='carGrid'" value="필터취소"></p>
</form>
</div>
	...
	<tr>
		...
		<td>
			<table class="link" onclick="location.href='carinfo?no=${dto.no}'" align="center" height="50px" width="500px">
				...
				<tr align="center" height="60px" width="300px">
